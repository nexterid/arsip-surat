...
e.fnDrawCallback,"user_old");z(n,"aoServerParams",e.fnServerParams,"user_old");z(n,"aoStateSaveParams",e.fnStateSaveParams,"user_old");z(n,"aoStateLoadParams",e.fnStateLoadParams,"user_old");z(n,"aoStateLoaded",e.fnStateLoaded,"user_old");z(n,"aoRowCallback",e.fnRowCallback,"user_old");z(n,"aoRowCreatedCallback",e.fnCreatedRow,"user_old");z(n,"aoHeaderCallback",e.fnHeaderCallback,"user_old");z(n,"aoFooterCallback",e.fnFooterCallback,"user_old");z(n,"aoInitComplete",e.fnInitComplete,"user_old");z(n,"aoPreDrawCallback",e.fnPreDrawCallback,
"user_old");n.rowIdFn=Q(e.rowId);gb(n);i=n.oClasses;e.bJQueryUI?(h.extend(i,m.ext.oJUIClasses,e.oClasses),e.sDom===l.sDom&&"lfrtip"===l.sDom&&(n.sDom='<"H"lfr>t<"F"ip>'),n.renderer)?h.isPlainObject(n.renderer)&&!n.renderer.header&&(n.renderer.header="jqueryui"):n.renderer="jqueryui":h.extend(i,m.ext.classes,e.oClasses);q.addClass(i.sTable);n.iInitDisplayStart===k&&(n.iInitDisplayStart=e.iDisplayStart,n._iDisplayStart=e.iDisplayStart);null!==e.iDeferLoading&&(n.bDeferLoading=!0,g=h.isArray(e.iDeferLoading),
